...
export function registerTools(server: McpServer): void {
  ...
  server.tool(
    ...
    '向小说大纲中添加一个节点（卷/幕/场景）。如果提供了 volume_id 或 act_id，会自动创建连线。',
    {
      ...
      act_number: z.union([z.literal(1), z.literal(2), z.literal(3)]).optional().describe('幕次 1/2/3（仅幕类型）'),
  ...
  server.tool(
    ...
    '更新大纲节点的属性',
    {
      ...
      act_number: z.union([z.literal(1), z.literal(2), z.literal(3)]).optional().describe('新幕次'),
    ...
    '批量创建大纲结构。一次性创建完整的卷→幕→场景层级结构，自动建立连线。这是构建大纲最高效的方式。',
    {
      ...
      volumes: z.array(z.object({
        ...
        acts: z.array(z.object({
          ...
          act_number: z.union([z.literal(1), z.literal(2), z.literal(3)]).describe('幕次 1/2/3'),
